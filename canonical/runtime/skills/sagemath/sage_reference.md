...
$env:AAS_SAGE_BIN = "/home/<wsl-user>/sage-10.4/sage"  # use this when sage is not on the non-interactive WSL PATH
...
or set `AAS_SAGE_BIN`; aliases are not visible to non-interactive runtime calls.
