...
PROVIDER_CLI_SPECS: dict[str, dict[str, Any]] = {
    ...
    "deepseek": {
        "candidates": {
            "linux": ["${AAS_DEEPSEEK}", "deepseek", "deepseek-cli", "~/.local/bin/deepseek"],
            "macos": ["${AAS_DEEPSEEK}", "deepseek", "deepseek-cli", "/opt/homebrew/bin/deepseek"],
            "wsl": ["${AAS_DEEPSEEK}", "deepseek", "deepseek-cli", "~/.local/bin/deepseek"],
            "windows": ["%AAS_DEEPSEEK%", "deepseek.cmd", "deepseek.exe", "deepseek"],
        }
    },
