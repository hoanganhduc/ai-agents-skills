...
TARGET_SURFACES: tuple[TargetSurface, ...] = (
    ...
    TargetSurface(
        ...
        "official-docs",
        "The writing router uses Codex's global AGENTS.md surface; instruction documents remain separate and are read on demand.",
    ),
    TargetSurface(
        "codex",
        "instruction-doc",
        ...
        "installer-convention",
        "Instruction docs copy to ~/.codex/instructions/ and are activated through the managed writing router or a writing consumer skill.",
    ),
    TargetSurface(
        "claude",
        "skill-file",
    ...
    TargetSurface(
        ...
        "official-docs",
        "The writing router references separate instruction documents without duplicating their policy text.",
    ),
    TargetSurface(
        "deepseek",
        "skill-file",
    ...
    TargetSurface(
        ...
        "supported",
        "instruction-block",
        "managed block in ~/.deepseek/AGENTS.md",
        "installer-convention",
        "The writing router is installed statically; native loading remains unverified when no DeepSeek CLI is available.",
    ),
    TargetSurface(
        "copilot",
        "skill-file",
    ...
    TargetSurface(
        ...
        "supported",
        "instruction-block",
        "managed block in ~/.config/opencode/AGENTS.md",
        "official-docs",
        "The writing router uses OpenCode's global AGENTS.md surface and leaves opencode.json user-owned.",
    ),
    TargetSurface(
        "antigravity",
        "skill-file",
    ...
    TargetSurface(
        ...
        "official-docs",
        "Instruction docs copy to ~/.grok/rules/; Grok 1.0.5 inspect output confirms those files are global rules. Native smoke verifies discovery without claiming model obedience.",
    ),
    TargetSurface(
        "grok",
        "template",
