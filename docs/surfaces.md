...
The current manifest contains 35 installable skills; the matrix below describes the target/surface support contract that those generated skill and artifact plans use.
