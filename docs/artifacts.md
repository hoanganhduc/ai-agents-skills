...
| `template:lean-repo-audit-checklist` | Static audit checklist for Lean repositories before builds, AXLE calls, verifier runs, or remote scans. | `lean-formalization-intake` |
| `template:lean-verifier-policy` | Trust-tier policy template for Lean build, AXLE, theorem-intent, and strict-verifier evidence. | `lean-formalization-intake` |
